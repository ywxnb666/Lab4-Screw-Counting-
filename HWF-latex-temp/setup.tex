...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {计算机视觉课程大作业 \LaTeX{} 模板示例文档},
    en / title           = {A Template Document for AI4701 Final Homework},
    %
    % 课程/学科名称 (将作为页眉显示)
    %
    zh / subject         = {AI4701-课程大作业},
    %
    % 课程/学科名称 (将作为页眉显示)
    %
    zh / subject         = {AI4701-课程大作业},
    ...
    en / keywords        = {SJTU, AI4701, XeTeX/LaTeX template},
    %
    % 姓名
    %
    zh / author          = {某\quad{}某},
